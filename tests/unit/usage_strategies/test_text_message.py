...
def test_base_cost():
    ...
    assert strategy.calculate_usage() == TextMessageUsageStrategy.BASE_COST
...
def test_character_count():
    ...
    assert pytest.approx(strategy.calculate_usage()) == pytest.approx(expected)
...
def test_palindrome():
    ...
    assert pytest.approx(strategy.calculate_usage()) == pytest.approx(base_cost * 2)
