...
def test_report_message():
    message = Message(
        text="report please", timestamp=datetime.datetime(2024, 1, 1, 0, 0, 0), id=42, report_id=3
    )
...
def test_messages():
    messages = Messages(
        messages=[
            Message(text="test text", timestamp=datetime.datetime(2024, 1, 1, 0, 0, 0), id=42),
            Message(
                text="report please",
